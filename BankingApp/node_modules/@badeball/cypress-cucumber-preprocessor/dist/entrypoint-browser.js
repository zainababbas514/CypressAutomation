...
function attach(data, mediaTypeOrOptions) {
    ...
    if (typeof data === "string") {
        ...
        if (mediaType.startsWith("base64:")) {
            createStringAttachment(data, fileName, mediaType.replace("base64:", ""), messages.AttachmentContentEncoding.BASE64);
        }
        else {
            createStringAttachment(data, fileName, mediaType !== null && mediaType !== void 0 ? mediaType : "text/plain", messages.AttachmentContentEncoding.IDENTITY);
        }
    }
        ...
        createStringAttachment((0, base64_js_1.fromByteArray)(new Uint8Array(data)), fileName, mediaType, messages.AttachmentContentEncoding.BASE64);
    }
    else {
