...
exports.suggestion = exports.createStringAttachmentHandler = exports.testCaseFinishedHandler = exports.testRunHookFinishedHandler = exports.testRunHookStartedHandler = exports.testStepFinishedHandler = exports.testStepStartedHandler = exports.testCaseStartedHandler = exports.specEnvelopesHandler = exports.afterSpecHandler = exports.beforeSpecHandler = exports.CypressCucumberStateError = void 0;
...
async function beforeRunHandler(config) {
    ...
    const testRunStarted = {
        testRunStarted: {
            id: (0, assertions_1.ensure)(config.env["testRunStartedId"], "Expected to find a testRunStartedId"),
...
async function afterRunHandler(config, results) {
    ...
    if (preprocessor.attachments.addVideos && "runs" in results) {
        ...
        if (hasVideos) {
            ...
            const testRunStartedId = (0, assertions_1.ensure)(config.env["testRunStartedId"], "Expected to find a testRunStartedId");
...
exports.testRunHookStartedHandler = createGracefullPluginEventHandler(async (config, data) => {
...
exports.testRunHookFinishedHandler = createGracefullPluginEventHandler(async (config, data) => {
...
exports.suggestion = createGracefullPluginEventHandler(async (config, data) => {
