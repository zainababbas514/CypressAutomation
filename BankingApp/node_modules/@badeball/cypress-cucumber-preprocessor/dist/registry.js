...
class Registry {
    ...
    defineCaseHook(keyword, options, fn) {
        ...
        this.preliminaryCaseHooks.push(Object.assign({ node: parseMaybeTags(options.tags), implementation: fn, keyword: keyword, position: (0, source_map_1.maybeRetrievePositionFromSourceMap)(), order: order !== null && order !== void 0 ? order : exports.DEFAULT_HOOK_ORDER }, remainingOptions));
    }
