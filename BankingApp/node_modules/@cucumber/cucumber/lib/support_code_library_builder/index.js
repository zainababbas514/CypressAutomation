...
class SupportCodeLibraryBuilder {
    ...
    buildTestRunHookDefinitions(configs, canonicalIds) {
        return configs.map(({ code, line, options, uri }, index) => {
            const wrappedCode = this.wrapCode({
                code,
                wrapperOptions: options.wrapperOptions,
    ...
    finalize(canonicalIds) {
        ...
        return {
            ...
            afterTestRunHookDefinitions: this.buildTestRunHookDefinitions(this.afterTestRunHookDefinitionConfigs, canonicalIds?.afterTestRunHookDefinitionIds),
            ...
            beforeTestRunHookDefinitions: this.buildTestRunHookDefinitions(this.beforeTestRunHookDefinitionConfigs, canonicalIds?.beforeTestRunHookDefinitionIds),
