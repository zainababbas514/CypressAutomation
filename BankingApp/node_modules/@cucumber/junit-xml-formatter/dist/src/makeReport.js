...
function makeTestCases(query) {
    return query.findAllTestCaseStarted().map((testCaseStarted) => {
        const pickle = ensure(query.findPickleBy(testCaseStarted), 'Expected to find Pickle by TestCaseStarted');
        ...
        return {
            ...
            output: query
                ...
                const pickleStep = ensure(query.findPickleStepBy(testStep), 'Expected to find PickleStep by TestStep');
                const gherkinStep = ensure(query.findStepBy(pickleStep), 'Expected to find Step by PickleStep');
